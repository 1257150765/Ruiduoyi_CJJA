...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initGpio(){
        ...
        gpioSignalReceiver=new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                if ("com.ruiduoyi.GpioUploadError".equals(intent.getAction())){
        ...
        receiverfilter.addAction("com.ruiduoyi.GpioUploadError");
    ...
    private void AutoUpdateApp(){
        ...
        String delay_time= RdyApplication.delayTime;
        Log.e(TAG,"auto_updata_num:"+auto_updata_num+"，delay_time："+delay_time);
