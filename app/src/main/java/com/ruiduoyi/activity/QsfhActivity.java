...
public class QsfhActivity extends BaseActivity {
    ...
    private void initList1(JSONArray lists) throws JSONException {
        ...
        for (int i=0;i<lists.length();i++){
            ...
            map.put("lab_3",lists.getJSONObject(i).getString("moe_ph"));
            ...
            map.put("lab_12",lists.getJSONObject(i).getString("mjm_mjmc"));
            ...
            public View getEasyView(final int position, View convertView, ViewGroup parent) {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dialog.getOkbtn().setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                //制造单号，模具编号，人员
                                fuHeEven(data.get(position).get("lab_2"),data.get(position).get("lab_6"),wkno);
                                dialog.dismiss();
                            }
                        });
                ...
                bg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        getList2Data(data.get(position).get("lab_1"),data.get(position).get("lab_2"),data.get(position).get("lab_6"));
                    }
                });
                return view;
            }
